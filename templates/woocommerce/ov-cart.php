...
<div class="ov-cart page-cart ov-page-bg">
    <div class="ov-container">
        ...
        <!-- SADRŽAJ -->
        <div class="ov-cart-content ov-two-column">
            <!-- LEVA KOLONA: koraci -->
            <div class="ov-cart-steps ov-steps">
                <div class="ov-step ov-step-active">
                    ...
                    <?php if (is_user_logged_in()): ?>
                        <button type="button" class="ov-step-button ov-btn js-continue">
                            <?php esc_html_e('Continue', 'ov-booking'); ?>
                        </button>
                    <?php else: ?>
                        <button type="button" class="ov-step-button ov-btn js-open-login-modal">
            ...
            <div class="ov-cart-summary">
                <div class="ov-summary-card ov-card">
                    <!-- Slika proizvoda -->
                    <div class="ov-summary-image ov-card-image">
                        <?php
                    ...
                    <div class="ov-summary-details ov-card-body">
                        <h2 class="ov-summary-title ov-heading-small"><?php echo esc_html($product->get_name()); ?></h2>
                        <p class="ov-summary-policy">
                            <?php esc_html_e('This reservation is non-refundable.', 'ov-booking'); ?>
                            <a href="#" class="ov-link-white"><?php esc_html_e('Full policy', 'ov-booking'); ?></a>
                        </p>
                        <hr>
                        ...
                        <hr>
                        <!-- Price details -->
                        <div class="ov-summary-price-row ov-summary-row ">
                            <div class="ov-summary-left">
                                <span
                            ...
                            <div class="ov-summary-right">
                                <details class="ov-price-details-accordion">
                                    <summary class="ov-link-white"><?php esc_html_e('Price breakdown', 'ov-booking'); ?>
                                    </summary>
